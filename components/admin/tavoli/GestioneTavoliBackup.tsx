...
import { getTavoliAdmin, creaTavolo, aggiornaTavolo, eliminaTavolo } from '@/lib/actions/tavoli';
import { getGruppiTavoli, creaGruppoTavoli, aggiornaGruppoTavoli, eliminaGruppoTavoli } from '@/lib/actions/gruppi-tavoli';
